...
from app.service.ai_log.ai_log_service import delete_old_ai_logs
...
def setup_scheduler():
    ...
    # 新增：添加自动删除 AI 日志的定时任务，每天凌晨0点10分执行，保留 3 天
    scheduler.add_job(
        delete_old_ai_logs,
        "cron",
        hour=0,
        minute=10,
        id="delete_old_ai_logs_job",
        name="Delete Old AI Logs",
    )
    logger.info("Auto-delete AI logs job scheduled to run daily at 00:10, keeping 3 days.")
